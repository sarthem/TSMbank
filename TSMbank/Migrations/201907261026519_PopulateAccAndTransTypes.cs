namespace TSMbank.Migrations
{
    ...
    public partial class PopulateAccAndTransTypes : DbMigration
    {
        public override void Up()
        {
            ...
            Sql($"INSERT INTO dbo.BankAccountTypes (Id,Description, InterestRate, PeriodicFee, Summary) VALUES ({BankAccountType.PublicServices}, 4, 0, 1000, 'Public Payment Service')");
